...
const Homepage = ()=>{
    ...
    return(
        <div className='homepage-container' style={{width: '65%'}}>
            <header>
                <img src={banner} className='banner' style={{width: '100%', height: 'auto'}}/>
            ...
            <div>
                <div className='features'>
                    <img src= {feature1} className='feature' style={{width: '100%', height: 'auto'}}/>
                    <h3>Feature 1</h3>
                ...
                <br />
                <div className='features'>
                    <img src={feature2} className='feature' style={{width: '100%', height: 'auto'}}/>
                    <h3>Feature 2</h3>
